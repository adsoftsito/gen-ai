...
def build_generator():
    """
    Crea el generador que convierte ruido en imágenes.
...
def generate_and_show_images(num_images=16):
    ...
    print("Imágenes guardadas en 'generated_images.png'")
    plt.show()
...
print("Gráfico de pérdidas guardado en 'training_losses.png'")
plt.show()
